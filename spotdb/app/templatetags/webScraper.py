...
def scrape_now(printer):
    ...
    with open("spotV2.csv", "w", newline='') as database:
        ...
        csv_writer.writerow(
            ["COMP16412 Programming 2", "16412-Cwk1-S-Part-1", "/", "12-Mar-21 18:00	", "Student Name"])
        csv_writer.writerow(
            ["COMP16412 Programming 2", "16412-Cwk2-S-Part-2", "/", "30-Apr-21 17:00", "Student Name"])
        csv_writer.writerow(
            ["COMP15212 Operating Systems", "15212-Lab3-S-Cache", "/", "16-Apr-21 17:00", "Student Name"])
        csv_writer.writerow(
            ["COMP15212 Operating Systems", "15212-Lab5-S-Experiment", "/", "14-May-21 17:00", "Student Name"])
        csv_writer.writerow(
            ["COMP13212 Data Science", "13212-LAB4-S-Statistical reasoning", "/", "16-Apr-21 12:27", "Student Name"])
        csv_writer.writerow(
            ["COMP13212 Data Science", "13212-LAB5-S-Machine Learning", "/", "07-May-21 17:00", "Student Name"])
        csv_writer.writerow(
            ["COMP11212 Fundamentals of Computation", "11212-exercise4-S-Exercise 4", "/", "23-Apr-21 17:00", "Student Name"])
        csv_writer.writerow(
            ["COMP11212 Fundamentals of Computation", "13212-LAB5-S-Machine Learning", "/", "07-May-21 17:00", "Student Name"])
